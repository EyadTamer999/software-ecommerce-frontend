...
const CompanyDetailsForm = ({ data, setData, handleChange }) => {
    const addressFields = [
        { label: 'Street Name', key: 'street', placeholder: "Enter company's street name" },
        { label: 'Label', key: 'label', placeholder: "Enter company's label" },
        { label: 'Building', key: 'building', placeholder: "Enter company's building" },
        { label: 'Apartment', key: 'apartment', placeholder: "Enter company's apartment" },
        { label: 'Floor', key: 'floor', placeholder: "Enter company's floor" },
        { label: 'Country', key: 'country', placeholder: "Enter company's country" },
        { label: 'State', key: 'state', placeholder: "Enter company's state" },
        { label: 'City', key: 'city', placeholder: "Enter company's city" },
        { label: 'Postal Code', key: 'postalCode', placeholder: "Enter company's postal code" },
        { label: 'Extra description', key: 'extra', placeholder: "Enter extra description" },
    ];
