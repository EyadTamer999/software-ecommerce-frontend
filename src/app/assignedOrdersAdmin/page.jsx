...
const assignedOrders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            try {
                const response = await fetch(`http://localhost:3001/order-gateway/get-order-queue`, {
                    method: "GET",
                    headers: {
    ...
    const handlePendingOrder = async (orderId) => {
        ...
        try {
            const response = await fetch(`http://localhost:3001/order-gateway/update-order-status/${orderId}`, {
                method: "PUT",
                headers: {
                    'Authorization': `Bearer ${token}`
                }
    ...
    const handleCancelOrder = async (orderId) => {
        ...
        try {
            const response = await fetch(`http://localhost:3001/order-gateway/update-order-status-closed/${orderId}`, {
                method: "PUT",
                headers: {
                    'Authorization': `Bearer ${token}`
                }
